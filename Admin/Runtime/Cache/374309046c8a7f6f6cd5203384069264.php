...
$(function(){
    ...
    $("#editor").val('<?php echo ($art["content"]); ?>');
    $("#class").val(<?php echo ($art["classid"]); ?>);
    $("#type").val(<?php echo ($art["typeid"]); ?>);
    $("input[name='options'][value=<?php echo ($art["flag"]); ?>]").prop("checked",true);
});
        ...
        <div id="mainpart" class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
            ...
            <div id="art">
              <form class="form-horizontal">
                <fieldset>
                    <input id="aid" type="hidden" value="<?php echo ($art["id"]); ?>"/>
                    <div class="form-group">
                      <label for="title" class="col-lg-1 control-label">标题</label>
                      <div class="col-lg-7">
                        <input type="text" class="form-control" id="title" placeholder="title" maxlength="64" value="<?php echo ($art["title"]); ?>"/>
                      </div>
            ...
            <form class="form-horizontal">
                <fieldset>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-10">
                            <input type="text" class="form-control tags" id="t1" value="<?php echo ($art["tags"]); ?>"/>
