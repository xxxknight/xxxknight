...
#toTop {
	...
	height: 50px;
	width: 50px;
	background: url(__ROOT__/resources/images/top.png) no-repeat;
}
/* 定义关键帧 */
@
...
<script type="text/javascript"
	src="__ROOT__/plugins/jquery-1.10.2.min.js"></script>
<script type="text/javascript">
...
<body>
	...
	<script
		src="__ROOT__/resources/assets/js/ie10-viewport-bug-workaround.js"></script>
</body>
</html>